...
load_audio_end_second = 6; %-1 for whole file
...
global max_corrupted_block_length = 200;
...
[  P_U_S_O_RK_output_signal,...
   ...
   P_U_S_O_RK_activate_threshold  ] = P_B_S_O_RK(input_signal);   
%%% Plotting results 
if should_plot
...
if should_save_audio
  ...
  save_audio(current_file, "P_U_S_O_RK", P_U_S_O_RK_output_signal, frequency, 1);
endif
