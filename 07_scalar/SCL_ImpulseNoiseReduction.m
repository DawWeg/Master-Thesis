function [input_signal, detection_signal, ewls_error_trajectory, threshold_trajectory, ewls_coefficients_estimate, ewls_noise_variance] = SCL_ImpulseNoiseReduction (input_signal)
