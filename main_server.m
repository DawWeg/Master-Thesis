...
for i=1:length(filenames)
  ...
  [  P_U_S_C_RK_output_signal,...
     P_U_S_C_RK_detection_signal,...
     P_U_S_C_RK_prediction_errors,...
     P_U_S_C_RK_activate_threshold  ] = P_U_S_C_RK(input_signal);   
     
  [  P_U_S_C_VK_output_signal,...
     P_U_S_C_VK_detection_signal,...
     P_U_S_C_VK_prediction_errors,...
     P_U_S_C_VK_activate_threshold  ] = P_U_S_C_VK(input_signal);   
  ...
  [  P_U_S_O_VK_output_signal,...
     P_U_S_O_VK_detection_signal,...
     P_U_S_O_VK_prediction_errors,...
     P_U_S_O_VK_activate_threshold  ] = P_U_S_O_VK(input_signal);
  %%% Save data
  ...
  save_data(current_file, "P_U_S_C_RK",...
         [ input_signal,...
           P_U_S_C_RK_output_signal,...
           P_U_S_C_RK_detection_signal,...
           P_U_S_C_RK_prediction_errors,...
           P_U_S_C_RK_activate_threshold ], 0);
           
  save_data(current_file, "P_U_S_C_VK",...
         [ input_signal,...
           P_U_S_C_VK_output_signal,...
           P_U_S_C_VK_detection_signal,...
           P_U_S_C_VK_prediction_errors,...
           P_U_S_C_VK_activate_threshold ], 0);
  ...
  save_data(current_file, "P_U_S_O_VK",...
         [ input_signal,...
           P_U_S_O_VK_output_signal,...
           P_U_S_O_VK_detection_signal,...
           P_U_S_O_VK_prediction_errors,...
           P_U_S_O_VK_activate_threshold ], 0);
  %%% Saving audio files
  save_audio(current_file,"R_U_S_T_RK", R_U_S_T_RK_output_signal, frequency, 0);
  save_audio(current_file,"P_B_S_O_RK", P_B_S_O_RK_output_signal, frequency, 0);
  save_audio(current_file,"P_U_S_C_RK", P_U_S_C_RK_output_signal, frequency, 0);
  save_audio(current_file,"P_U_S_C_VK", P_U_S_C_VK_output_signal, frequency, 0);
  save_audio(current_file,"P_U_S_O_RK", P_U_S_O_RK_output_signal, frequency, 0);
  save_audio(current_file,"P_U_S_O_VK", P_U_S_O_VK_output_signal, frequency, 0);
endfor
